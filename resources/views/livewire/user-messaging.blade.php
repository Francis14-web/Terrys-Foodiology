<div>
    <div class="flex flex-col sm:w-[40vw] w-full sm:h-[700px] h-[500px] bg-green-700 bg-opacity-30 overflow-y-auto">
        <div class="flex flex-col px-4 ">
            @foreach ($messages as $text)
                @if ($text->sender_id == Auth::guard('user')->user()->id)
                    {{-- Sender --}}
    ...
    <div class=" bg-green-700 bg-opacity-30 bottom-0 h-auto sm:w-[40vw] w-full align-center rounded-b-lg">
