    ...
    <aside id="sidebar" class="fixed top-0 left-0 max-w-[270px] w-full bg-[#1e4d2b] h-full ">
        ...
        <div class="flex flex-col justify-between ">
            <div class="flex flex-col gap-2 ml-10 ">
                <a href="{{ route('canteen.dashboard') }}" class="flex items-center gap-6 py-2 px-3 text-white text-sm w-full {{ request()->routeIs('canteen.dashboard') ? 'bg-white pl-8 rounded-l-full text-lime-600 font-extrabold' : '' }} hover:flex hover:items-center hover:bg-gray-900 hover:pl-8 hover:rounded-l-full hover:text-lime-600 hover:font-extrabold"><i class=' bx bxs-home'></i> Home</a>
                <a href="{{ route('canteen.menu')}}" class="flex items-center gap-6 py-2 px-3 text-white text-sm w-full {{ request()->routeIs('canteen.menu') ? 'bg-white pl-8 rounded-l-full text-lime-600 font-extrabold' : '' }} hover:flex hover:items-center hover:bg-gray-900 hover:pl-8 hover:rounded-l-full hover:text-lime-600 hover:font-extrabold"><i class=' bx bxs-book'></i> Menu</a>
                <a href="#" class="flex items-center gap-6 py-2 px-3 text-white text-sm w-full {{ request()->routeIs('') ? 'bg-white pl-8 rounded-l-full text-lime-600 font-extrabold' : '' }} hover:flex hover:items-center hover:bg-gray-900 hover:pl-8 hover:rounded-l-full hover:text-lime-600 hover:font-extrabold"><i class=' bx bxs-credit-card-front'></i> Sales</a>
                ...
                <a href="#" class="flex items-center gap-6 py-2 px-3 text-white text-sm w-full {{ request()->routeIs('') ? 'bg-white pl-8 rounded-l-full text-lime-600 font-extrabold' : '' }} hover:flex hover:items-center hover:bg-gray-900 hover:pl-8 hover:rounded-l-full hover:text-lime-600 hover:font-extrabold"><i class='bx bxs-user-circle'></i> Profile</a>
