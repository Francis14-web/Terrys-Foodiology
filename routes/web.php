...
Route::middleware('canteen')->group(function () {
    ...
    Route::get('/canteen/user-order/{orders}', 'App\Http\Controllers\CanteenController@viewOrder')->name('canteen.order.view');
...
Route::middleware(['user', 'is_restricted', 'is_verified', 'is_expired'])->group(function () {
